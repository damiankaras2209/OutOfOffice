...
namespace OutOfOffice.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private readonly IUserEmailStore<EmployeeModel> _emailStore;
        ...
        private IUserEmailStore<EmployeeModel> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<EmployeeModel>)_userStore;
        }
    }
}
